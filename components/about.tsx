        ...
        <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-3">
          {pillars.map((p, i) => (
            <Reveal
              key={p.tag}
              delay={i * 0.1}
              className="rounded-2xl border border-line/60 bg-surface p-8 transition-colors hover:border-primary/30"
            >
              <span className="mb-3 block text-[11px] font-semibold uppercase tracking-[0.14em] text-primary">
                {p.tag}
              </span>
